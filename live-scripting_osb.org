...
#+OPTIONS: toc:nil
#+LANGUAGE: en
#+Title: Installation of Oracle OSB using Live-Scripting medthod
#+Startup: showall
#+Include: "latex_setup.org"
#+CATEGORY: LLV
#+TODO: TODO(t!/!) WAIT(w!/!) MAYBE(m!/!) | DONE(d!/!) NOTE(n!/!) CANCELED(!c)
...
| Documentation (PDF)  | [[file:live-scripting_osb.pdf][live-scripting_osb.pdf]]                                |
| Documentation (HTML) | [[file+sys:live-scripting_osb.html]]                      |
...
cd /Users/aupeksha/LocalProjects/live-scripting_osb
ls -la
rsync -avP live-scripting_osb.html ubuntu_wp_parallels:/site/wordpress/labs/live-scripting_osb/
rsync -avP live-scripting_osb.pdf ubuntu_wp_parallels:/site/wordpress/labs/live-scripting_osb/
rsync -avP aw-org-html-themes ubuntu_wp_parallels:/site/wordpress/labs/live-scripting_osb/
rsync -avP data ubuntu_wp_parallels:/site/wordpress/labs/live-scripting_osb/
rsync -avP docs ubuntu_wp_parallels:/site/wordpress/labs/live-scripting_osb/
rsync -avP styles ubuntu_wp_parallels:/site/wordpress/labs/live-scripting_osb/
...
The 
https://ubuntu2204_wordpress/labs/live-scripting_osb/live-scripting_osb.html
